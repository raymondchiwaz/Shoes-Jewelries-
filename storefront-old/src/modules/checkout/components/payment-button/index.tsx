...
const PaymentButton: React.FC<PaymentButtonProps> = ({
  ...
  // Check for ShipRank carrier in cart metadata (in addition to Medusa shipping methods)
  const hasShipRankCarrier = !!getShipRankCarrier(cart)
  const hasShippingMethod = (cart.shipping_methods?.length ?? 0) > 0 || hasShipRankCarrier
