...
// Collection-specific default hero images
const getDefaultHeroImage = (handle: string): string => {
  const heroImages: Record<string, string> = {
    luxury: "/images/content/hi.png",
    casual: "/images/content/living-room-gray-two-seater-puffy-sofa.png",
    // Add more collections here as needed
  }
  const selectedImage = heroImages[handle.toLowerCase()] || "/images/content/collections.png"
  console.log(`[DEBUG] Collection handle: "${handle}" → Image: "${selectedImage}"`)
      ...
      <div className="max-md:mt-18 relative aspect-[2/1] md:h-screen w-full max-w-full mb-8 md:mb-19">
        <Image
          src={
            ...
            getDefaultHeroImage(collection.handle || "")
          }
          fill
