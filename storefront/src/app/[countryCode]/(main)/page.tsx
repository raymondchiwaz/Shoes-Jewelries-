...
export const metadata: Metadata = {
  title: "Guavaland | Luxury Bags, Eyewear & Casual Shoes",
  description:
    "Discover high-quality luxury bags, precision eyewear, and premium casual shoes at Guavaland. Elevate your style with our curated collection.",
}
    ...
    <>
      <div className="max-md:pt-18">
        <Image
          ...
          width={2880}
          height={1500}
          alt="Shoes and Jewelry Collection"
      ...
      <div className="pt-8 pb-26 md:pt-26 md:pb-36">
        <Layout className="mb-26 md:mb-36">
          <LayoutColumn start={1} end={{ base: 13, md: 8 }}>
            <h3 className="text-md max-md:mb-6 md:text-2xl">
              Discover Premium Shoes & Jewelry
            </h3>
          </LayoutColumn>
          <LayoutColumn start={{ base: 1, md: 9 }} end={13}>
            <div className="flex items-center h-full">
              <div className="md:text-md">
                <p>Step Into Style Today</p>
        ...
        <ProductTypesSection />
        <FeaturedProductsSection className="mb-22 md:mb-36" countryCode={countryCode} />
        <Layout>
          ...
          <LayoutColumn start={1} end={{ base: 13, md: 7 }}>
            <h2 className="text-md md:text-2xl">
              At Guavaland, we believe in quality that speaks for itself.
            </h2>
          </LayoutColumn>
          <LayoutColumn
            start={{ base: 1, md: 8 }}
          ...
          >
            <div className="md:text-md">
              <p className="mb-5 md:mb-9">
                We curate high-quality luxury bags, precision eyewear, and premium casual shoes that combine style, craftsmanship, and enduring quality.
              </p>
              <p className="mb-5 md:mb-3">
                Our mission is to help you express your unique style with products that are built to last and designed to command attention.
              </p>
              <LocalizedLink href="/about" variant="underline">
                Read more about Guavaland
              </LocalizedLink>
            </div>
          </LayoutColumn>
        </Layout>
